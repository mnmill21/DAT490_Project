...
\begin{table}[H]
\centering
\caption{Working dataset shapes before and after cleaning and aggregation}
\label{tab:datasets}
\begin{tabular}{lrr}
\toprule
